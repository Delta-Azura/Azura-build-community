...
def compile():
    principal_vrai=input("donner nous le chemin vers votre coatfile : ")
    os.chdir(principal_vrai)
    coatfile_vrai=input("Quel est le nom de votre coatfile ? : ")
    azura-coat  = open("coatfile_vrai", "r")
